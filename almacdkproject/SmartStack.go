...
// The jsii proxy struct for SmartStack
type jsiiProxy_SmartStack struct {
	internal.Type__awscdkStack
}

func (j *jsiiProxy_SmartStack) Account() *string {
	var returns *string
	_jsii_.Get(
		j,
		"account",
...
func (j *jsiiProxy_SmartStack) ArtifactId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"artifactId",
...
func (j *jsiiProxy_SmartStack) AvailabilityZones() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"availabilityZones",
...
func (j *jsiiProxy_SmartStack) BundlingRequired() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"bundlingRequired",
...
func (j *jsiiProxy_SmartStack) Dependencies() *[]awscdk.Stack {
...
func (j *jsiiProxy_SmartStack) Environment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environment",
...
func (j *jsiiProxy_SmartStack) Nested() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"nested",
...
func (j *jsiiProxy_SmartStack) NestedStackParent() awscdk.Stack {
	var returns awscdk.Stack
	_jsii_.Get(
		j,
		"nestedStackParent",
...
func (j *jsiiProxy_SmartStack) NestedStackResource() awscdk.CfnResource {
...
func (j *jsiiProxy_SmartStack) Node() constructs.Node {
...
func (j *jsiiProxy_SmartStack) NotificationArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"notificationArns",
...
func (j *jsiiProxy_SmartStack) Partition() *string {
	var returns *string
	_jsii_.Get(
		j,
		"partition",
...
func (j *jsiiProxy_SmartStack) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SmartStack) StackId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stackId",
...
func (j *jsiiProxy_SmartStack) StackName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stackName",
...
func (j *jsiiProxy_SmartStack) Synthesizer() awscdk.IStackSynthesizer {
...
func (j *jsiiProxy_SmartStack) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_SmartStack) TemplateFile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateFile",
...
func (j *jsiiProxy_SmartStack) TemplateOptions() awscdk.ITemplateOptions {
...
func (j *jsiiProxy_SmartStack) TerminationProtection() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SmartStack) UrlSuffix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"urlSuffix",
...
func NewSmartStack(scope constructs.Construct, id *string, props *awscdk.StackProps) SmartStack {
	...
	if err := validateNewSmartStackParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SmartStack)SetTerminationProtection(val *bool) {
...
func SmartStack_IsConstruct(x interface{}) *bool {
	...
	if err := validateSmartStack_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SmartStack_IsStack(x interface{}) *bool {
	...
	if err := validateSmartStack_IsStackParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SmartStack_Of(construct constructs.IConstruct) awscdk.Stack {
	...
	if err := validateSmartStack_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns awscdk.Stack
...
func (s *jsiiProxy_SmartStack) AddDependency(target awscdk.Stack, reason *string) {
...
func (s *jsiiProxy_SmartStack) AddMetadata(key *string, value interface{}) {
...
func (s *jsiiProxy_SmartStack) AllocateLogicalId(cfnElement awscdk.CfnElement) *string {
...
func (s *jsiiProxy_SmartStack) ExportStringListValue(exportedValue interface{}, options *awscdk.ExportValueOptions) *[]*string {
...
func (s *jsiiProxy_SmartStack) ExportValue(exportedValue interface{}, options *awscdk.ExportValueOptions) *string {
...
func (s *jsiiProxy_SmartStack) FormatArn(components *awscdk.ArnComponents) *string {
...
func (s *jsiiProxy_SmartStack) GetLogicalId(element awscdk.CfnElement) *string {
...
func (s *jsiiProxy_SmartStack) RegionalFact(factName *string, defaultValue *string) *string {
...
func (s *jsiiProxy_SmartStack) ReportMissingContextKey(report *cloudassemblyschema.MissingContext) {
...
func (s *jsiiProxy_SmartStack) Resolve(obj interface{}) interface{} {
...
func (s *jsiiProxy_SmartStack) SplitArn(arn *string, arnFormat awscdk.ArnFormat) *awscdk.ArnComponents {
...
func (s *jsiiProxy_SmartStack) ToJsonString(obj interface{}, space *float64) *string {
...
func (s *jsiiProxy_SmartStack) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SmartStack) ToYamlString(obj interface{}) *string {
