...
func (s *jsiiProxy_SmartStack) validateAddMetadataParameters(key *string, value interface{}) error {
	return nil
}
...
func (s *jsiiProxy_SmartStack) validateExportStringListValueParameters(exportedValue interface{}, options *awscdk.ExportValueOptions) error {
	return nil
}
...
func (s *jsiiProxy_SmartStack) validateToYamlStringParameters(obj interface{}) error {
	return nil
}
...
func (j *jsiiProxy_SmartStack) validateSetTerminationProtectionParameters(val *bool) error {
	return nil
}
